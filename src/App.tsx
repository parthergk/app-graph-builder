...
function App() {
  ...
  return (
    <div className="w-screen h-screen flex flex-col bg-bg-dark/60 dark:bg-bg-dark/95 text-foreground font-sans overflow-hidden transition-colors duration-200">
      <TopBar
        theme={theme}
