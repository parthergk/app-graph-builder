        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="relative w-full">
                ...
                <input
                    ...
                    className="w-full bg-black/[0.03] dark:bg-black/40 border border-border-dark rounded-lg pl-9 pr-4 py-2 text-xs text-foreground placeholder:text-text-muted outline-none focus:border-primary focus:ring-1 focus:ring-primary dark:focus:border-border-dark dark:focus:ring-border-dark transition-all"
                />
            </div>
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center justify-between w-full p-3 rounded-xl border transition-all duration-200 text-left cursor-pointer group ${isActive
                                    ? 'bg-bg-active border-border-dark text-foreground font-medium shadow-sm dark:shadow-md dark:shadow-black/30'
                                    : 'bg-transparent border-transparent text-text-muted hover:text-foreground hover:bg-bg-active/40 dark:hover:text-white'
                                    }`}
                            >
                                <div className="flex items-center gap-3">
                                    <Icon
                                        className={`w-4.5 h-4.5 transition-colors ${isActive
                                            ? 'text-foreground'
                                            : 'text-text-muted group-hover:text-foreground dark:group-hover:text-white'
                                            }`}
                                    />
