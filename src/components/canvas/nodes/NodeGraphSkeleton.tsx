export function NodeGraphSkeleton() {
  return (
    <div className="h-full w-full flex items-center justify-center bg-bg-dark relative overflow-hidden select-none">
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none text-border-dark dark:text-zinc-800 opacity-60 dark:opacity-40">
      ...
      <div className="absolute left-[25%] top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
        <div className="w-[180px] h-[74px] bg-bg-panel border border-border-dark rounded-xl animate-pulse flex items-center px-4 gap-3 shadow-lg">
          <div className="w-10 h-10 rounded-lg bg-bg-active dark:bg-zinc-800 flex-shrink-0" />
          <div className="flex-1 space-y-2">
            <div className="h-3 bg-bg-active dark:bg-zinc-800 rounded w-4/5" />
            <div className="h-2 bg-bg-active/60 dark:bg-zinc-800/60 rounded w-1/2" />
          </div>
        </div>
      </div>

      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
        <div className="w-[180px] h-[74px] bg-bg-panel border border-border-dark rounded-xl animate-pulse flex items-center px-4 gap-3 shadow-lg ring-2 ring-primary/20">
          <div className="w-10 h-10 rounded-lg bg-bg-active dark:bg-zinc-800 flex-shrink-0" />
          <div className="flex-1 space-y-2">
            <div className="h-3 bg-bg-active dark:bg-zinc-800 rounded w-3/4" />
            <div className="h-2 bg-bg-active/60 dark:bg-zinc-800/60 rounded w-2/3" />
          </div>
        </div>
      </div>
      ...
      <div className="absolute left-[75%] top-[30%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
        <div className="w-[180px] h-[74px] bg-bg-panel border border-border-dark rounded-xl animate-pulse flex items-center px-4 gap-3 shadow-lg">
          ...
          <div className="flex-1 space-y-2">
            <div className="h-3 bg-bg-active dark:bg-zinc-800 rounded w-4/5" />
            <div className="h-2 bg-bg-active/60 dark:bg-zinc-800/60 rounded w-1/3" />
          </div>
        </div>
      </div>
      ...
      <div className="absolute left-[75%] top-[70%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
        <div className="w-[180px] h-[74px] bg-bg-panel border border-border-dark rounded-xl animate-pulse flex items-center px-4 gap-3 shadow-lg">
          <div className="w-10 h-10 rounded-lg bg-bg-active dark:bg-zinc-800 flex-shrink-0" />
          <div className="flex-1 space-y-2">
            <div className="h-3 bg-bg-active dark:bg-zinc-800 rounded w-2/3" />
            <div className="h-2 bg-bg-active/60 dark:bg-zinc-800/60 rounded w-1/2" />
          </div>
        </div>
      </div>
